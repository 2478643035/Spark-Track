...
import "./styles.css";
import { NexusSettingTabV11 } from "./settings-v11";
import { DailyNoteServiceV11 } from "./services/daily-note-service-v11";
import { GoalServiceV11 } from "./services/goal-service-v11";
import { TaskServiceV11 } from "./services/task-service-v11";
import type {
  CaptureEntry,
  GoalSummary,
  GoalTrackerStatus,
...
import { NexusCommandViewV11 } from "./view/nexus-view-v11";
...
export default class NexusCommandPluginV11 extends Plugin implements NexusViewController {
  ...
  private dailyNoteService!: DailyNoteServiceV11;
  private taskService!: TaskServiceV11;
  private goalService!: GoalServiceV11;
  ...
  async onload(): Promise<void> {
    ...
    this.dailyNoteService = new DailyNoteServiceV11(this);
    this.taskService = new TaskServiceV11(this, this.dailyNoteService);
    this.goalService = new GoalServiceV11(this);

    this.registerView(VIEW_TYPE, (leaf) => new NexusCommandViewV11(leaf, this));
    ...
    this.addSettingTab(new NexusSettingTabV11(this.app, this));
